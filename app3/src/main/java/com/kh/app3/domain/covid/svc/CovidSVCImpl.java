...
//    String edate = endDate.format(DateTimeFormatter.ofPattern("yyyyMMdd"));
    ...
    try {
      ...
      urlBuilder.append("?" + URLEncoder.encode("serviceKey", "UTF-8") + "=5LH66reUfNhyGbG%2FebiNPR5BIsCw%2FjUT7iB5HrB1IqVKWVILf%2Ftm4ujyyvGk4GNIJmhXX5QYYcDJEdUxe0O3Vw%3D%3D"); /*Service Key*/
